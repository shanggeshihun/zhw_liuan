...
select '{2}' as part_day,a.userid,count(distinct a.id) as orders,count(distinct b.did) as cd_orders,count(distinct b.did)*1.00/count(distinct a.id) as cd_ratio
