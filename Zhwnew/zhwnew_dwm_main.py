...
for i in lst:
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_init', 'run', last_day, last_day
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_main_behavior_by_eventday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_and_war_users', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_measures_by_createday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_success_measures_by_createday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_measures_by_refundday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_settled_measures_by_createday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_measures_by_payday', 'run', last_8day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_measures_by_sendday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_war_measures_by_prizeday', 'run', last_8day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_war_measures_by_sendday', 'run', last_8day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_war_measures_by_applysendday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_recharge_measures_by_addday', 'run', last_8day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_recharge_refund_measures_by_refundday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_register_byday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_recharge_measures_by_addday_status', 'run', last_8day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    # class_instance, class_method, start_day, end_day = 'wow_dwm_device_activate_by_firsttime', 'run', last_day, last_day
    # ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_wabao_inout_byaddday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
    ...
    class_instance, class_method, start_day, end_day = 'wow_dwm_shop_and_war_measures_by_payday', 'run', last_day, last_day
    ts.run_task(class_instance, class_method, start_day, end_day)
