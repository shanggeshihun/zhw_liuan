...
# @Author    : An
# @File      : sm_root_hook_emulator_for_sh_group.py
# @Software  : PyCharm
...
def sm_root_hook_emulator_for_sh_group(day_last_1, now_day, group_id):
    '''
    :param day_last_1:
    :param now_day:
    :param group_id:
...
if __name__ == '__main__':
    ...
    """2023-04-07，针对数美root设备|是否hook设备|PC模拟器命中用户且商户订单 封禁上号OAID
    group_name 手游查询封号用户群(关闭数美风险规则用户上号oaid)
    """
    try:
        sm_root_hook_emulator_for_sh_group(now_day, now_day, 48)
    except Exception as e:
        print('sm_root_hook_emulator_for_sh_group 异常信息:\n', e)
    pass