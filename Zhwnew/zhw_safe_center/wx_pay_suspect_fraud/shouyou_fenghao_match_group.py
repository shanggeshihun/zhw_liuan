...
holo_cnx = create_engine(
    "postgresql+psycopg2://" + holo_user + ":" + holo_password + "@" + holo_host + ":" + holo_port + "/" + holo_database)
...
def shouyou_fenghao_match_group(start_day, end_day, group_id):
    ...
    print(sql)
    sys.exit()
    report1 = pd.read_sql(sql, con=holo_cnx)
    report2 = report1.copy()

    report2.fk_target_id = report2.fk_target_id + 1
...
if __name__ == '__main__':
    ...
    shouyou_fenghao_match_group(start_day, end_day, 44)
