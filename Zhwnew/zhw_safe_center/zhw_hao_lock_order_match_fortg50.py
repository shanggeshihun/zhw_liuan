...
# @Author    : An
# @File      : zhw_hao_lock_order_match_fortg50.py
# @Software  :

# 20230406 1836 按照检测时间推送
# 20230629 1427 更改holo host 改成 读
...
holo_host = cf.get("Hologres_defend_w", "host")
holo_user = cf.get("Hologres_defend_w", "user")
holo_password = cf.get("Hologres_defend_w", "password")
holo_DB = cf.get("Hologres_defend_w", "db")
holo_port = cf.get("Hologres_defend_w", "port")
