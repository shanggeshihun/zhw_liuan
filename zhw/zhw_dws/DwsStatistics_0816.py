...
# @Software  : zhw_dws_msg_recall_statistics,zhw_dws_red_packet_type_id_msg,zhw_dws_push_recall_statistics。2022/8/5 将 【3日内下单】【3日红包下单】分开执行，【3日红包下单】 红包先关联红包下单再关联下单表，红包订单表 添加type/issue条件;添加使用红包复购；将sql2 和 SQL6 拆开，将 select * 指定字段，强关联的时候left 改join
