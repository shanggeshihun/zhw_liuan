...
class ZhwAnalysis:
    ...
    def certificate_users_dim_month_bigaddfrom(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/certificate_users_dim_month_bigaddfrom_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.certificate_users_dim_month_bigaddfrom(part_month)
        end_time = time.time()
        print('certificate_users_dim_month_bigaddfrom，运行耗时：%s s' % (end_time - start_time))