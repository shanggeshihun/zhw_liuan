...
# @Time　　 : 2022/6/11 8:56
# @Author　 : liuan
# @File　 　: login_new_user_retain_dim_month.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def login_new_user_retain_dim_month(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/login_new_user_retain_dim_month_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.login_new_user_retain_dim_month(part_month)
        end_time = time.time()
        print('login_new_user_retain_dim_month，运行耗时：%s s' % (end_time - start_time))
