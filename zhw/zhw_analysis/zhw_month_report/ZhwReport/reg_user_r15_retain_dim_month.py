...
# @Time      : 2022/6/14  16:39
# @Author    : An
# @File      : reg_user_r15_retain_dim_month.py
# @Software  : PyCharm
...
class ZhwAnalysis:
    ...
    def reg_user_r15_retain_dim_month(self, part_month):
        """
        ...
        presto_sql = """
            select 
                ...
                count(b.userid) as r15_retain_users
            from 
            (
        ...
        df_result.to_excel(r"./zhw_rpt_data/reg_user_r15_retain_dim_month_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    part_month_list = ['2022-01', '2022-02', '2022-03', '2022-04', '2022-05', '2021-01', '2021-02', '2021-03',
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.reg_user_r15_retain_dim_month(part_month)
        end_time = time.time()
        print('reg_user_r15_retain_dim_month，运行耗时：%s s' % (end_time - start_time))
