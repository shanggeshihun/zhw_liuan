...
# @Time　　 : 2022/6/11 1:18
# @Author　 : liuan
# @File　 　: topgame_gmv_dim_month_game.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def topgame_gmv_dim_month_game(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/topgame_gmv_dim_month_game_{0}.xlsx".format(part_month), index=False)
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.topgame_gmv_dim_month_game(part_month)
        end_time = time.time()
        print('topgame_gmv_dim_month_game，运行耗时：%s s' % (end_time - start_time))
