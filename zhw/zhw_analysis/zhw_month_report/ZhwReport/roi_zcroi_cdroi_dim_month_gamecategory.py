...
# @Author　 : liuan
# @File　 　: roi_zcroi_cdroi_dim_month_gamecategory.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def roi_zcroi_cdroi_dim_month_gamecategory(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/roi_zcroi_cdroi_dim_month_gamecategory_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.roi_zcroi_cdroi_dim_month_gamecategory(part_month)
        end_time = time.time()
        print('roi_zcroi_cdroi_dim_month_gamecategory，运行耗时：%s s' % (end_time - start_time))
