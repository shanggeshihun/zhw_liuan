...
# @Time　　 : 2022/6/11 9:04
# @Author　 : liuan
# @File　 　: reg_user_r7_retain_dim_month.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def reg_user_r7_retain_dim_month(self, part_month):
        """
        ...
        presto_sql = """
            select 
                ...
                count(b.userid) as r7_retain_users
            from 
            (
        ...
        df_result.to_excel(r"./zhw_rpt_data/reg_user_r7_retain_dim_month_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.reg_user_r7_retain_dim_month(part_month)
        end_time = time.time()
        print('reg_user_r7_retain_dim_month，运行耗时：%s s' % (end_time - start_time))
