...
# @Time　　 : 2022/6/11 9:04
# @Author　 : liuan
# @File　 　: reg_user_r1_retain_dim_month.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def reg_user_r1_retain_dim_month(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/reg_user_r1_retain_dim_month_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    part_month_list = ['2022-01' ,'2022-02' ,'2022-03' ,'2022-04' ,'2022-05' ,'2021-01' ,'2021-02' ,'2021-03' ,'2021-04' ,'2021-05' ,'2021-06' ,'2021-07' ,'2021-08' ,'2021-09' ,'2021-10' ,'2021-11' ,'2021-12'
]
    part_month_list = ['2022-11', '2021-11']
    for part_month in part_month_list:
        start_time = time.time()
        zhw_analysis = ZhwAnalysis()
        zhw_analysis.reg_user_r1_retain_dim_month(part_month)
        end_time = time.time()
        print('reg_user_r1_retain_dim_month，运行耗时：%s s' % (end_time - start_time))
