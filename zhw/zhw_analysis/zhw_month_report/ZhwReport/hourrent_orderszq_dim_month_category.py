...
class ZhwAnalysis:
    ...
    def hourrent_orderszq_dim_month_category(self, part_month):
        """
        ...
        df_result.to_excel(r"./zhw_rpt_data/hourrent_orderszq_dim_month_category_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.hourrent_orderszq_dim_month_category(part_month)
        end_time = time.time()
        print('hourrent_orderszq_dim_month_category，运行耗时：%s s' % (end_time - start_time))
