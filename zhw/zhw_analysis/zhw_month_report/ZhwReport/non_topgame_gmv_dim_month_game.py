...
# @Time　　 : 2022/6/11 1:18
# @Author　 : liuan
# @File　 　: non_topgame_gmv_dim_month_game.py
# @Theme : PyCharm
...
class ZhwAnalysis:
    ...
    def non_topgame_gmv_dim_month_game(self, part_month):
        """
        ...
        presto_sql = """
            ...
            (
                ...
                where part_month='{0}'
                and gameid not in (11,17,581,24,443,683,560,446)
            ) a 
            inner join 
            (
        ...
        df_result.to_excel(r"./zhw_rpt_data/non_topgame_gmv_dim_month_game_{0}.xlsx".format(part_month), index=False)
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.non_topgame_gmv_dim_month_game(part_month)
        end_time = time.time()
        print('non_topgame_gmv_dim_month_game，运行耗时：%s s' % (end_time - start_time))
