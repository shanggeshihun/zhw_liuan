...
class ZhwAnalysis:
    ...
    def login_user_retain_dim_month(self, part_month):
        """
        ...
        df_result.iloc[:,1:]
        df_result.to_excel(r"./zhw_rpt_data/login_user_retain_dim_month_{0}.xlsx".format(part_month))
...
if __name__ == '__main__':
    ...
    for part_month in part_month_list:
        ...
        zhw_analysis.login_user_retain_dim_month(part_month)
        end_time = time.time()
        print('login_user_retain_dim_month，运行耗时：%s s' % (end_time - start_time))
