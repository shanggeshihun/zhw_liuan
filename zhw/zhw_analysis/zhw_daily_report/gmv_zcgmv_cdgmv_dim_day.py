...
class ZhwAnalysis:
    ...
    def gmv_zcgmv_cdgmv_dim_day(self, start_day, end_day):
        """
        ...
        df_result.to_excel(r"./daily_export_data/gmv_zcgmv_cdgmv_dim_day_{0}_to_{1}.xlsx".format(start_day, end_day))
...
if __name__ == '__main__':
    ...
    start_day, end_day = '2022-08-29', '2022-09-08'
    start_time = time.time()
    zhw_analysis = ZhwAnalysis()
    zhw_analysis.gmv_zcgmv_cdgmv_dim_day(start_day, end_day)
    end_time = time.time()
    print('gmv_zcgmv_cdgmv_dim_day，运行耗时：%s s' % (end_time - start_time))